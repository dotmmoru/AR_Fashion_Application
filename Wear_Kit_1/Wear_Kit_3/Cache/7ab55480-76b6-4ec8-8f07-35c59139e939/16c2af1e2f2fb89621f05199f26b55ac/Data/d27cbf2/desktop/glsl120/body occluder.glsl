...
#endif
vec4 l9_7=sc_SampleTextureBiasOrLevel(bodyMaskDims.xy,bodyMaskLayout,l9_6,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_bodyMask)!=0),bodyMaskTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_bodyMask,SC_SOFTWARE_WRAP_MODE_V_bodyMask),(int(SC_USE_UV_MIN_MAX_bodyMask)!=0),bodyMaskUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_bodyMask)!=0),bodyMaskBorderColor,0.0,bodyMask);
