...
//sampler sampler bodyMaskSmpSC 2:18
...
//texture texture2D bodyMask 2:1:2:18
...
//texture texture2DArray Tweak_N0ArrSC 2:27:2:17
//texture texture2DArray bodyMaskArrSC 2:28:2:18
//texture texture2DArray intensityTextureArrSC 2:29:2:19
...
uniform vec4 bodyMaskDims;
uniform float extrude;
uniform float bellyPush;
...
uniform vec4 bodyMaskSize;
uniform vec4 bodyMaskView;
uniform mat3 bodyMaskTransform;
uniform vec4 bodyMaskUvMinMax;
uniform vec4 bodyMaskBorderColor;
...
float l9_33=(((abs(l9_28.x-Port_Input1_N017)-Port_RangeMinA_N018)/(Port_RangeMaxA_N018-Port_RangeMinA_N018))*(Port_RangeMaxB_N018-Port_RangeMinB_N018))+Port_RangeMinB_N018;
float l9_34;
if (Port_RangeMaxB_N018>Port_RangeMinB_N018)
{
l9_34=clamp(l9_33,Port_RangeMinB_N018,Port_RangeMaxB_N018);
}
else
{
l9_34=clamp(l9_33,Port_RangeMaxB_N018,Port_RangeMinB_N018);
}
float l9_35=(((abs(l9_28.y-Port_Input1_N014)-Port_RangeMinA_N015)/(Port_RangeMaxA_N015-Port_RangeMinA_N015))*(Port_RangeMaxB_N015-Port_RangeMinB_N015))+Port_RangeMinB_N015;
float l9_36;
if (Port_RangeMaxB_N015>Port_RangeMinB_N015)
{
l9_36=clamp(l9_35,Port_RangeMinB_N015,Port_RangeMaxB_N015);
}
else
{
l9_36=clamp(l9_35,Port_RangeMaxB_N015,Port_RangeMinB_N015);
}
...
l9_40=varTangent.xyz;
l9_39=l9_32;
l9_38=(l9_30+(l9_31*vec3(extrude)))+((Port_Input0_N022*vec3(l9_37))*vec3(bellyPush));
}
varPos=l9_38;
varNormal=normalize(l9_39);
vec3 l9_41=normalize(l9_40);
...
#if (sc_RenderingSpace==3)
{
l9_42=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_43;
#if (sc_RenderingSpace==2)
{
l9_43=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_44;
#if (sc_RenderingSpace==1)
{
l9_44=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
l9_44=l9_17;
...
#if (sc_RenderingSpace==4)
{
l9_46=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_47;
...
#endif
vec4 l9_50=sc_ProjectorMatrix*l9_49;
varShadowTex=((l9_50.xy/vec2(l9_50.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_51;
...
{
vec4 l9_53=l9_45;
l9_53.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_45.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_45.w;
l9_52=l9_53;
}
else
{
...
{
float l9_54=dot(l9_51,sc_StereoClipPlanes[sc_StereoViewID]);
...
#endif
#ifndef bodyMaskHasSwappedViews
#define bodyMaskHasSwappedViews 0
#elif bodyMaskHasSwappedViews==1
#undef bodyMaskHasSwappedViews
#define bodyMaskHasSwappedViews 1
#endif
#ifndef bodyMaskLayout
#define bodyMaskLayout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_bodyMask
#define SC_USE_UV_TRANSFORM_bodyMask 0
#elif SC_USE_UV_TRANSFORM_bodyMask==1
#undef SC_USE_UV_TRANSFORM_bodyMask
#define SC_USE_UV_TRANSFORM_bodyMask 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_bodyMask
#define SC_SOFTWARE_WRAP_MODE_U_bodyMask -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_bodyMask
#define SC_SOFTWARE_WRAP_MODE_V_bodyMask -1
#endif
#ifndef SC_USE_UV_MIN_MAX_bodyMask
#define SC_USE_UV_MIN_MAX_bodyMask 0
#elif SC_USE_UV_MIN_MAX_bodyMask==1
#undef SC_USE_UV_MIN_MAX_bodyMask
#define SC_USE_UV_MIN_MAX_bodyMask 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_bodyMask
#define SC_USE_CLAMP_TO_BORDER_bodyMask 0
#elif SC_USE_CLAMP_TO_BORDER_bodyMask==1
#undef SC_USE_CLAMP_TO_BORDER_bodyMask
#define SC_USE_CLAMP_TO_BORDER_bodyMask 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
uniform sampler2DArray bodyMaskArrSC;
...
int bodyMaskGetStereoViewIndex()
{
int l9_0;
#if (bodyMaskHasSwappedViews)
{
l9_0=1-sc_GetStereoViewIndex();
}
#else
...
#if (Tweak_N0Layout==2)
{
l9_2=sc_SampleTextureBiasOrLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_1,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,0.0,Tweak_N0ArrSC);
}
#else
{
...
#endif
vec4 l9_3=baseColor*vec4(1.0,1.0,1.0,l9_2.x);
vec4 l9_4;
#if (bodyMaskLayout==2)
{
l9_4=sc_SampleTextureBiasOrLevel(bodyMaskDims.xy,bodyMaskLayout,bodyMaskGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_bodyMask)!=0),bodyMaskTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_bodyMask,SC_SOFTWARE_WRAP_MODE_V_bodyMask),(int(SC_USE_UV_MIN_MAX_bodyMask)!=0),bodyMaskUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_bodyMask)!=0),bodyMaskBorderColor,0.0,bodyMaskArrSC);
}
#else
{
l9_4=sc_SampleTextureBiasOrLevel(bodyMaskDims.xy,bodyMaskLayout,bodyMaskGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_bodyMask)!=0),bodyMaskTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_bodyMask,SC_SOFTWARE_WRAP_MODE_V_bodyMask),(int(SC_USE_UV_MIN_MAX_bodyMask)!=0),bodyMaskUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_bodyMask)!=0),bodyMaskBorderColor,0.0,bodyMask);
}
#endif
bool l9_5=(float(l9_2.x>=Port_Input1_N016)*1.0)!=0.0;
bool l9_6;
if (!l9_5)
{
l9_6=(float(l9_4.x<=Port_Input1_N029)*1.0)!=0.0;
}
else
{
l9_6=l9_5;
...
{
l9_11=clamp(dot(l9_3.xyz,vec3(l9_7)),0.0,1.0);
}
#else
{
float l9_12;
...
{
l9_13=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*l9_7;
}
#else
{
float l9_14;
...
{
l9_14=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*l9_7;
}
#else
{
float l9_15;
...
{
l9_15=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_7;
}
#else
{
float l9_16;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_17=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_7;
}
#else
{
float l9_18;
...
{
l9_18=dot(l9_3.xyz,vec3(0.33333001))*l9_7;
}
#else
{
float l9_19;
#if (sc_BlendMode_Min)
{
l9_19=1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_20;
#if (sc_BlendMode_Max)
{
l9_20=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_20=1.0;
...
#endif
l9_8=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_3.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_9);
}
#else
{
vec4 l9_21;
...
#else
{
vec2 l9_27=sc_ScreenCoordsGlobalToView(l9_0);
int l9_28;
...
#endif
vec3 l9_32=mix(l9_30.xyz,definedBlend(l9_30.xyz,l9_3.xyz).xyz,vec3(l9_7));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_34=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_7)),l9_7);
}
#else
{
vec4 l9_35;
...
#endif
l9_35=vec4(l9_3.xyz*l9_36,l9_36);
}
#else
{
l9_35=l9_3;
