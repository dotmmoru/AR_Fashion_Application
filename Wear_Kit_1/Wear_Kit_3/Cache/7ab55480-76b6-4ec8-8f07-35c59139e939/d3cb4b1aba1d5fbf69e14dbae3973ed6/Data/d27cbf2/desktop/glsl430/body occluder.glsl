...
#endif
float l9_0=(((distance(varPackedTex.xy,Port_Input1_N014)-Port_RangeMinA_N015)/(Port_RangeMaxA_N015-Port_RangeMinA_N015))*(Port_RangeMaxB_N015-Port_RangeMinB_N015))+Port_RangeMinB_N015;
float l9_1;
if (Port_RangeMaxB_N015>Port_RangeMinB_N015)
{
l9_1=clamp(l9_0,Port_RangeMinB_N015,Port_RangeMaxB_N015);
}
else
{
l9_1=clamp(l9_0,Port_RangeMaxB_N015,Port_RangeMinB_N015);
}
vec4 l9_2=vec4(l9_1);
...
#endif
vec3 l9_27=mix(l9_25.xyz,definedBlend(l9_25.xyz,l9_2.xyz).xyz,vec3(l9_1));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_29=vec4(mix(vec3(1.0),l9_2.xyz,vec3(l9_1)),l9_1);
}
#else
{
vec4 l9_30;
