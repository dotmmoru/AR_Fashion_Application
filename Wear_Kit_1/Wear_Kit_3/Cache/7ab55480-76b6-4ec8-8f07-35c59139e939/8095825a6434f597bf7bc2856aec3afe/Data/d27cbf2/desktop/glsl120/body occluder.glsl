...
#endif
float l9_0=(((abs(varPackedTex.x-Port_Input1_N017)-Port_RangeMinA_N018)/(Port_RangeMaxA_N018-Port_RangeMinA_N018))*(Port_RangeMaxB_N018-Port_RangeMinB_N018))+Port_RangeMinB_N018;
float l9_1;
if (Port_RangeMaxB_N018>Port_RangeMinB_N018)
{
l9_1=clamp(l9_0,Port_RangeMinB_N018,Port_RangeMaxB_N018);
}
else
{
l9_1=clamp(l9_0,Port_RangeMaxB_N018,Port_RangeMinB_N018);
}
float l9_2=(((abs(varPackedTex.y-Port_Input1_N014)-Port_RangeMinA_N015)/(Port_RangeMaxA_N015-Port_RangeMinA_N015))*(Port_RangeMaxB_N015-Port_RangeMinB_N015))+Port_RangeMinB_N015;
float l9_3;
if (Port_RangeMaxB_N015>Port_RangeMinB_N015)
{
l9_3=clamp(l9_2,Port_RangeMinB_N015,Port_RangeMaxB_N015);
}
else
{
l9_3=clamp(l9_2,Port_RangeMaxB_N015,Port_RangeMinB_N015);
}
float l9_4=l9_1*l9_3;
vec4 l9_5=vec4(l9_4);
