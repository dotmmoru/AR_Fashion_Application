...
//sampler sampler Tweak_N0SmpSC 2:16
...
//texture texture2D Tweak_N0 2:0:2:16
...
//texture texture2DArray Tweak_N0ArrSC 2:25:2:16
...
if ((float(l9_2.x>=Port_Input1_N016)*1.0)!=0.0)
{
discard;
}
float l9_4=l9_3.w;
...
#endif
vec3 l9_29=mix(l9_27.xyz,definedBlend(l9_27.xyz,l9_3.xyz).xyz,vec3(l9_4));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_31=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_4)),l9_4);
}
#else
{
vec4 l9_32;
...
#endif
l9_32=vec4(l9_3.xyz*l9_33,l9_33);
}
#else
{
l9_32=l9_3;
