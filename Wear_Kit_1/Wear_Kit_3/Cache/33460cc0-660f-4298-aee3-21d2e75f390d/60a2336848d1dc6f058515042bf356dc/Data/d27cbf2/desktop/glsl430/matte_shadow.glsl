...
//sampler sampler opacityTexSmpSC 2:22
...
//texture texture2D opacityTex 2:4:2:22
...
//texture texture2DArray opacityTexArrSC 2:33:2:22
...
{
vec3 l9_10;
Node0_Shadow_Sample(l9_10,l9_8);
vec3 l9_11=l9_10;
vec2 l9_12;
...
{
vec2 l9_15;
Node29_If_else(0.0,vec2(0.0),vec2(0.0),l9_15,l9_8);
l9_14=l9_15;
}
#else
{
...
{
vec2 l9_19;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_19,l9_8);
l9_18=((l9_19*Tweak_N50)+Tweak_N51)+(Tweak_N51*(l9_1*Port_Speed_N063));
}
#else
{
vec2 l9_20;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_20,l9_8);
l9_18=(l9_20*Tweak_N50)+Tweak_N51;
}
#endif
l9_17=l9_18;
}
...
{
l9_21=sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,opacityTexGetStereoViewIndex(),l9_12,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTexArrSC);
}
#else
{
...
#endif
l9_9=mix(Port_Input0_N006,l9_11,vec3(l9_21.x));
}
#else
{
vec3 l9_22;
Node0_Shadow_Sample(l9_22,l9_8);
l9_9=l9_22;
}
#endif
vec4 l9_23=vec4(l9_9.x,l9_9.y,l9_9.z,vec4(0.0).w);
l9_23.w=Port_Value2_N001;
...
#endif
sc_writeFragData0(max(l9_24,vec4(0.0)));
return;
}
vec4 l9_26;
...
{
l9_28=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_29;
...
{
l9_29=clamp(dot(l9_23.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_30;
...
{
l9_31=(1.0-dot(l9_23.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_32;
...
{
l9_32=(1.0-clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_33;
...
{
l9_33=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_34;
#if (sc_BlendMode_Add)
{
l9_34=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_35;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_35=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_36;
...
{
l9_36=dot(l9_23.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_37;
#if (sc_BlendMode_Min)
{
l9_37=1.0-clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_38;
#if (sc_BlendMode_Max)
{
l9_38=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_38=1.0;
...
#endif
l9_26=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_23.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_27);
}
#else
{
vec4 l9_39;
...
{
l9_47=sc_SampleView(sc_ScreenTextureDims.xy,l9_45,sc_ScreenTextureLayout,l9_46,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_47=sc_SampleView(sc_ScreenTextureDims.xy,l9_45,sc_ScreenTextureLayout,l9_46,0.0,sc_ScreenTexture);
}
#endif
l9_41=l9_47;
}
...
#endif
vec3 l9_50=mix(l9_48.xyz,definedBlend(l9_48.xyz,l9_23.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_52=vec4(mix(vec3(1.0),l9_23.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_53;
...
{
l9_54=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_54=Port_Value2_N001;
}
#endif
l9_53=vec4(l9_23.xyz*l9_54,l9_54);
}
#else
{
l9_53=l9_23;
