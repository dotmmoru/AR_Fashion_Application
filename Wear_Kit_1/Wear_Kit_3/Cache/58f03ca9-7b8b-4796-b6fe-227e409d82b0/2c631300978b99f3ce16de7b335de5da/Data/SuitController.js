// @input Component.ObjectTracking legTrack
...
function updateTransforms(){
    ...
    //print(script.legTrack.isTracking());
    ...
    for (var i = 0; i < script.legsMeshes.length; i++){
        script.legsMeshes[i].enabled = isFullBody;
    }
